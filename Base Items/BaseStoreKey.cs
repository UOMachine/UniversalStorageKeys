...
namespace Server.Items
{
    ...
    public class BaseStoreKey : Item, IItemStoreObject, ISecurable
    {
        ...
        public static bool EmptyContents => true;
        ...
        public virtual int DisplayColumns => 2;

        public virtual bool CanUseFromPack => true;
        public virtual bool CanUseFromHouse => true;
        ...
        public SecureLevel Level { get => _SecureLevel; set => _SecureLevel = value; }

        public static Item LastWithdrawn => _LastWithdrawn;
        ...
        public virtual List<StoreEntry> EntryStructure => new List<StoreEntry>();
