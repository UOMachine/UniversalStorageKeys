...
namespace Solaris.ItemStore
{
    ...
    public class StashSortData : CollectionBase, IDisposable
    {
        ...
        //total gump width
        public int Width => this[Count - 1].X + this[Count - 1].Width;

        public List<StashSortEntry> AvailableColumns => _AvailableColumns;
        ...
        public StashSortData(StashSortEntry[] displayentries, StashSortEntry[] availableentries)
        {
            ...
            Add(new StashSortEntry("Item", "best name", 0, 100));
        ...
        public virtual StashSortEntry this[int index] => (StashSortEntry)(List[index]);
