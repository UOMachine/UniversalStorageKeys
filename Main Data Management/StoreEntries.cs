...
namespace Solaris.ItemStore
{
    ...
    public class StoreEntry
    {
        ...
        public virtual int ButtonID => 0x4B9;
        public virtual int ButtonX => 0;
        public virtual int ButtonY => 5;

        public virtual bool RequiresRecipient => false;
        ...
        public int X => _X;
        public int Y => _Y;
        public Type[] AlternateTypes => _AlternateTypes;
    ...
    {
        public bool Deedable { get; private set; }
        ...
        public ResourceEntry(Type type, Type[] subtypes, string name, int amount, int height, int x, int y) : base(type, subtypes, name, amount, height, x, y)
        {
            ...
            try
            {
                ...
                Deedable = (resource is ICommodity);
    ...
    {
        public override int ButtonID => 0x9A8;
        public override int ButtonX => 5;
        public override int ButtonY => -3;
    ...
    public class RunicToolEntry : StoreEntry
    {
        ...
        public CraftResource Resource => _Resource;
    ...
    public class ChampionSkullEntry : StoreEntry
    {
        ...
        public ChampionSkullType SkullType => _SkullType;
    ...
    {
        public override bool RequiresRecipient => true;
        ...
        public override Item FindRecipient(Mobile from)
        {
            ...
            {
                if (recipient.Held == 0 || recipient.Type == Effect && recipient.Held < 100)
                {
                    return recipient;
                }
            }
        ...
        public override Item WithdrawTo(ref int amount, Item destination)
        {
            ...
            if (destination is PotionKeg keg)
            {
                keg.Type = Effect;
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            switch (version)
            {
                ...
                default:
                    {
                        Effect = (PotionEffect)reader.ReadInt();
                        break;
                    }
            }
        }//deserialize
    ...
    public class BeverageEntry : StoreEntry
    {
        ...
        public override bool Add(Item item)
        {
            ...
            if (beverage.Content != BeverageType)
            {
                return false;
            }
        ...
        public override Item FindRecipient(Mobile from)
        {
            ...
            {
                if (recipient.Quantity == 0 || recipient.Content == BeverageType && !recipient.IsFull && recipient.Poison == null)
                {
                    return recipient;
                }
            }
        ...
        public override bool Match(Item item, bool checksubtypes)
        {
            if (item is BaseBeverage && ((BaseBeverage)item).Content == BeverageType)
            {
                return true;
            }
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            switch (version)
            {
                ...
                default:
                    {
                        BeverageType = (BeverageType)reader.ReadInt();
                        break;
                    }
            }
        }//deserialize
