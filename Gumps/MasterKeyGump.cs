...
namespace Server.Gumps
{
    ...
    public class MasterItemStoreKeyGump : Gump
    {
        ...
        readonly MasterItemStoreKey _Key;
        ...
        static readonly int _ArtworkColumn = 5;
        static readonly int _AccessColumn = _ArtworkColumn + 50;
        static readonly int _KeyNameColumn = _AccessColumn + 50;

        static readonly int _WithdrawColumn = Width - 80;
