...
namespace Server.Gumps
{
    ...
    public class ItemStoreGump : Gump
    {
        ...
        static readonly int _ItemColumn = 10;
        static readonly int _WithdrawColumn = _ItemColumn + 40;
        static readonly int _WithdrawDeedColumn = _WithdrawColumn + 17;
        static readonly int _ItemNameColumn = _WithdrawDeedColumn + 20;
        static readonly int _AmountColumn = _ItemNameColumn + 145;
        ...
        public int MaxEntryDisplayHeight => 400;
        public int ColumnWidth => 240;
