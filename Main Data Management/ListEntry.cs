...
namespace Solaris.ItemStore
{
    ...
    public class ListEntry : StoreEntry
    {
        ...
        public override int ButtonID => 0xFA6;
        public override int ButtonX => 0;
        public override int ButtonY => -3;

        //maximum amount to store in a ListEntry object
        public virtual int MaxAmount => 100000;
        ...
        public Type ItemListEntryType => _ItemListEntryType;

        //the amount property is used to display the amount of items stored within the list
        public override int Amount => ItemListEntries.Count;
        ...
        {
            readonly ListEntry _ListEntry;       //reference the list entry
