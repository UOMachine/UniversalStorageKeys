...
namespace Solaris.ItemStore
{
    ...
    public class ItemStore : IDisposable
    {
        ...
        public static int MaxAmount => 999999999;
        ...
        public List<StoreEntry> ExpelStoreEntries
        {
            ...
            set => _ExpelStoreEntries = value;
        }

        public int Count => StoreEntries.Count;
        ...
        {
            readonly ItemStore _Store;       //reference the store
        ...
        public void RefreshParentGump()
        {
            ...
            if (Owner != null && Owner is Item)
            {
                ...
                if (item.RootParent is Mobile player)
                {
        ...
        public static ItemStore Clone(ItemStore store)
        {
            ...
            {
                ExpelStoreEntries = StoreEntry.CloneList(store.ExpelStoreEntries),

                Label = store.Label,
                Dynamic = store.Dynamic,
                OfferDeeds = store.OfferDeeds,
                WithdrawAmount = store.WithdrawAmount,
                MinWithdrawAmount = store.MinWithdrawAmount,
                LootType = store.LootType,
                Insured = store.Insured,
                LockWithdrawalAmount = store.LockWithdrawalAmount,
